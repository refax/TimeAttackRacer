...
#include "TimeAttackRacerPawn.generated.h"
...
UCLASS(config=Game)
class ATimeAttackRacerPawn : public AWheeledVehicle
{
	GENERATED_BODY()
...
public:
	...
	class AMyPlayerController *PlayerControllerReference;
